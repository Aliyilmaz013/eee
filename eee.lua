...
local Window = Library.CreateLib("CPX STORE - BY SHEZZFY", "Ocean")
...
MainSection:NewButton("Dupe Pets (SOON)", "SOON", function()
    print("Clicked")
end)

MainSection:NewButton("Dupe Gems (SOON)", "SOON", function()
    print("Clicked")
end)
...
MainSection:NewButton("Admin Hub (SOON)", "SOON", function()
    loadstring(game:HttpGet(('https://raw.hithuusercontent.com/EdgeIY/infiniteyield/master/source%27),true))()
end)
